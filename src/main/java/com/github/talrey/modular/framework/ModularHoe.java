...
public class ModularHoe extends HoeItem implements IModularTool {
  public ModularHoe (Properties props) {
    this(ItemTier.WOOD, 1, 1f, props);
  }

  public ModularHoe (IItemTier itemTier, int baseDamage, float baseAttackSpeed, Properties props) {
    super(itemTier, baseDamage, baseAttackSpeed, props);
  }

  @Override
  public ModularToolComponent getFunctionComponent() {
    return ItemRegistration.FUNCTION_HOE.get();
  }
