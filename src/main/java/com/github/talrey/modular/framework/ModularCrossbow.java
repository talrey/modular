...
public class ModularCrossbow extends CrossbowItem implements IModularTool {
  public ModularCrossbow (Properties props) { super (props); }

  @Override
  public ModularToolComponent getFunctionComponent() {
    return ItemRegistration.FUNCTION_CROSSBOW.get();
  }
